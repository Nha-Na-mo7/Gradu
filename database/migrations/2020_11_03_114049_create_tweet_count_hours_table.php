...
class CreateTweetCountHoursTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tweet_count_hours', function (Blueprint $table) {
            ...
            $table->string('next_results')->nullable()->comment('アカウント検索再開時における設定パラメータ');
            $table->timestamps();
    ...
    {
        Schema::dropIfExists('tweet_count_hours');
    }
}
