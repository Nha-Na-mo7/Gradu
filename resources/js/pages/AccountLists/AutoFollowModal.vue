  ...
  <div>
    ...
    <div class="c-modal">
      ...
      <div class="c-modal__main">
        <h2 class="c-modal__main--info">アカウント一覧ページの全Twitterアカウントを、自動でフォローします。</h2>
        <ul class="c-modal__main--description">
          <li class="c-modal__main--li">連携済みのTwitterアカウントでフォローされます。</li>
          <li class="c-modal__main--li">フォローは約30分に5人のペースで行われるため、反映には少し時間がかかります。</li>
          <li class="c-modal__main--li">自動フォローをONにしている間、アカウント一覧ページからはフォロー出来ません。</li>
          <li class="c-modal__main--li">自動フォローはいつでも解除することが可能です。</li>
        </ul>
      </div>
